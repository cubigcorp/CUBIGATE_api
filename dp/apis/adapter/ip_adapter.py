...
class IPAdapter:
    def __init__(self, pipe, ip_ckpt, image_encoder_path, device="cuda", dtype=torch.float16, resample=Image.Resampling.LANCZOS):
        self.pipe = pipe
        self.device = device
        self.dtype = dtype
        
        # load ip adapter model
        ipadapter_model = torch.load(ip_ckpt, map_location="cpu")
