...
--data_folder /home/minsy/CUBIG/dp/data/age/train/41-50 \
...
--initial_prompt "A photo of a person aged 41 to 50" \
--make_fid_stats False \
--result_folder /home/minsy/CUBIG/dp/result/age/41-50 \
--tmp_folder /tmp/age/41-50 \
