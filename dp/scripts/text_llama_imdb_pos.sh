...
--initial_prompt "Generate BATCH positive movie reviews as if they were posted on IMDB. The review does not have a title, a number, or anything other than itself." \
--make_fid_stats True \
--compute_fid True \
--num_fid_samples 100 \
