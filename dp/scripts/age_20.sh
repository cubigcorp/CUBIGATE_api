...
--data_folder /home/minsy/CUBIG/dp/data/age/train/21-30 \
...
--initial_prompt "A photo of a person aged 21 to 30" \
--make_fid_stats False \
--result_folder /home/minsy/CUBIG/dp/result/age/21-30 \
--tmp_folder /tmp/age/21-30 \
