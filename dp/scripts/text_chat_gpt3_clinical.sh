...
--initial_prompt "Generate BATCH dialogs between a doctor and a patient at a clinic." \
--control_prompt "Each item does not have any titles or numbers but only a tail written as 'END' without any additional dividers at all." \
--make_fid_stats False \
--result_folder /home/minsy/CUBIG/dp/result/clinical/chatgpt3/12-04-2 \
...
--data_checkpoint_path /home/minsy/CUBIG/dp/result/clinical/chatgpt3/12-04-2/0/_samples.npz \
