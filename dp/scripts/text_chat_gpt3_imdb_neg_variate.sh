...
--initial_prompt "Generate a negative movie reviews as if it were posted on IMDB." \
...
--result_folder /mnt/cubigate/minsy/result/IMDB/public_seed/negative \
...
--public_data_folder /mnt/cubigate/minsy/dp_data/IMDB/public/train/negative \
--save_samples_live \
