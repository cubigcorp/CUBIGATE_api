...
--data_folder /home/minsy/CUBIG/dp/data/age/train/51-60 \
...
--initial_prompt "A photo of a person aged 51 to 60" \
--make_fid_stats False \
--result_folder /home/minsy/CUBIG/dp/result/age/51-60 \
--tmp_folder /tmp/age/51-60 \
