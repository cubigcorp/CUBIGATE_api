...
--data_folder /home/minsy/CUBIG/dp/data/drowsiness/TrainingSet/TrainingSet/Opened \
--num_samples_schedule 800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800 \
--variation_degree_schedule 1.0,0.98,0.96,0.94,0.92,0.88,0.84,0.8,0.76,0.72,0.68,0.64,0.6,0.56,0.52,0.48,0.44,0.4 \
--num_fid_samples 100 \
--num_private_samples 800 \
--initial_prompt "A photo of opened eye" \
--make_fid_stats False \
--result_folder /home/minsy/CUBIG/dp/result/drowsiness/opened/ \
--tmp_folder /tmp/drowsiness/opened \
