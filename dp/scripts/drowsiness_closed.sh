...
--data_folder /home/minsy/CUBIG/dp/data/drowsiness/TrainingSet/TrainingSet/Closed \
...
--initial_prompt "A photo of sleepy eye" \
--make_fid_stats False \
--result_folder /home/minsy/CUBIG/dp/result/drowsiness/closed/ \
--tmp_folder /tmp/drowsiness/closed \
