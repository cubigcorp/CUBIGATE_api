...
--data_folder /home/minsy/dpsda/DPSDA/data/chest/train/PNEUMONIA \
...
--initial_prompt "A photo of chest xray with pneumonia" \
--make_fid_stats True \
--result_folder /home/minsy/dpsda/DPSDA/result/chest/pneumonia/ \
--tmp_folder /tmp/chest/pneumonia \
...
--data_checkpoint_path result/chest/pneumonia/6/samples.npz \
--data_checkpoint_step 6
